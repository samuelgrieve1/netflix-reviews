...
user_1 = User.create(email: "first1@email.com", encrypted_password: "123456", username: "Mad Ducks", first_name: "Maddox", last_name: "Grey")
user_2 = User.create(email: "first2@email.com", encrypted_password: "123456", username: "Tedward", first_name: "Ted", last_name: "Francis")
user_3 = User.create(email: "first3@email.com", encrypted_password: "123456", username: "Luby_Writes_Ruby", first_name: "Eric", last_name: "Luby")
user_4 = User.create(email: "first4@email.com", encrypted_password: "123456", username: "SAMTHEDJ", first_name: "Sam", last_name: "Grieve")
user_5 = User.create(email: "first5@email.com", encrypted_password: "123456", username: "Couch_Surfer_Bryan", first_name: "Bryan", last_name: "Alicea")
